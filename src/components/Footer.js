          ...
          <div className="footer-grid">
            ...
            <div className="footer-section">
              ...
              <p className="footer-description">
                Your trusted partner for premium quality Indian products and reliable global export solutions.
              </p>
            ...
            <div className="footer-section">
              <h4>Services</h4>
              <ul className="footer-links">
                <li><a href="#sourcing">Product Sourcing</a></li>
                <li><a href="#quality">Quality Control</a></li>
                <li><a href="#logistics">Global Logistics</a></li>
                <li><a href="#documentation">Export Documentation</a></li>
            ...
            <div className="footer-section">
              ...
              <div className="contact-info">
                <div className="contact-item">
                  ...
                  <p>628, Level 6, 150 Feet Ring Rd, BRTS, near West zone, Rajkot<br />Gujarat, India - 360001</p>
                </div>
                <div className="contact-item">
                  <span className="contact-icon">
                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="footer-bottom-content">
            <p>&copy; 2024 OM Exports. All rights reserved.</p>
